...
================  ====================  ============================================================  
  :eq:`eq:u2`     $\hat{u}_{kl}(t)$     $(k, l) \in \boldsymbol{k}_B \times \boldsymbol{l}/\{0\}$  
:eq:`eq:div2`     $\hat{v}_{kl}(t)$     $(k, l) \in \boldsymbol{k}_D \times \boldsymbol{l}/\{0\}$  
  :eq:`eq:vx`     $\hat{v}_{kl}(t)$                    $(k, l) \in \boldsymbol{k}_D \times \{0\}$  
  :eq:`eq:T2`     $\hat{T}_{kl}(t)$           $(k, l) \in \boldsymbol{k}_T \times \boldsymbol{l}$  
================  ====================  ============================================================  
