...
def inner(expr0, expr1, output_array=None, level=0):
    ...
    expr0, expr1 : :class:`.Expr`, :class:`.BasisFunction`, :class:`.Array`
        ...
        If either expr0 or expr1 is a number (typically 1), then the inner
        product represents a non-weighted integral over the domain, and the
        other expression must be a scalar Array or a Function.
